...
def LoadTeams(Teams):
    ...
    TeamsPlayers = []
    TeamName = ''
    Teams.append(Team('Chelsea', 'Blue', 70000000, 'Mouricio', 'Sari', 433, Pool.Request('Chelsea')))
    Teams.append(Team('Arsenal', 'Red', 50000000, 'Emry', 'Unai', 442, Pool.Request('Arsenal')))
