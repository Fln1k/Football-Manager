...
def LoadTeams(Teams):
    PlayersPool = LoadPlayers()
    ManagerPool = LoadManagers()
    Teams.append(Team('Chelsea', 'Blue', 70000000,ManagerPool.RequestCoach('Chelsea'), PlayersPool.Request('Chelsea')))
    Teams.append(Team('Arsenal', 'Red', 50000000,ManagerPool.RequestCoach('Arsenal'), PlayersPool.Request('Arsenal')))
...
for Team in Leagues[0].Positions:
    print('{}   {}    {}    {}    {}   {}  {}   {}  {}PT'.format(Team.Name,Team.Games,Team.WinGames,Team.DrawGames,Team.LoseGames,Team.GoalsScore,Team.GoalsLose,Team.GoalsScore-Team.GoalsLose,Team.Points))